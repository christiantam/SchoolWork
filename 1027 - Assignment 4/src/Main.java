public class Main{
	...
	public static void main(String[] args) {
		...
		String segmented_filename="segmented-level-" + args[4] + "-" + redStg + "-" + greenStg + "-" + blueStg + "-" + args[0];
		String painted_filename="painted-level-" + args[4] + "-" + redStg + "-" + greenStg + "-" + blueStg + "-" + args[0];
